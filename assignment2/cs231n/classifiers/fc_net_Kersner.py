...
'''
  All this code was swiped from Martin Kersner:
    https://github.com/martinkersner/cs231n/blob/master/assignment2/fc_net.py
  I was encountering errors with dropout_bwd()   within FullyConnectedNets.loss(), and I couldn't understand where they were because when I looked at others' code, I couldn't tell where the differences were.
    So I just copied his code and am seeing whether it works (and hopefully understand why   so I can replicate his efforts without literally COPYING EVERY CHARACTER of his code)
'''
    ...
    for i in range(self.num_layers, 0, -1):
      ...
      if i == self.num_layers:
        ...
        if self.use_dropout:
          ...
          if debug:
            print('after dropout, dX = {0}'.format(der[:3,:3]))
        ...
        if self.use_batchnorm:
          ...
          if debug:
            print("after  batchnorm, dX = {0}".format(der[:3,:3]))
